...
для отображения и хранения графа и фиксирует предварительный выбор.
Выбор средств в §6.7–6.8 является
...
- Предварительная цель для изображения подграфа глубиной три — 2 секунды.
  Условия измерения ещё определяются по ОВ-04
  ([раздел 03](03-architecture.md), §3.7).
...
**Этап требований.** После обсуждения сценариев §6.4–6.12 и решения открытых
вопросов подготовить подробные требования и способы их проверки.

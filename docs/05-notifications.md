...
Этап: **постановка задачи и анализ решений**. Выведенные требования:
[системные](requirements/system.md) `СТ-УВД` и [требования к ПО](requirements/software.md) `ТП-УВД`.
...
Отметка о прочтении есть только у уведомления в веб-интерфейсе.
...
- **Требования:** проверить `СТ-УВД` и `ТП-УВД`; параметры §5.8 — до решения ОВ-04;

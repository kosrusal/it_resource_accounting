...
| 4. Граф | Расчёт влияния при аварии использует тот же обход, что и для регламентных работ, включая отношение «включает в себя» ([раздел 06](06-graph.md), §6.2); результат содержит признак полноты |
